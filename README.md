# MEPSS GROUP PERU — Sistema de Gestión Ferretera
...
**MEPSS GROUP PERU** es un sistema de gestión empresarial para ferreterías desarrollado como proyecto integrador. El sistema cubre los módulos de clientes, proveedores, inventario, ventas, empleados, asistencia, boletas/planillas y un dashboard analítico en tiempo real.
...
*Sistema desarrollado como proyecto integrador — MEPSS GROUP PERU © 2026*
